    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse text-center ms-md-5 ms-sm-0" id="navbarNavAltMarkup">
        <div class="col-md-6 col-sm-12 navbar-nav">
          ...
          <a class="nav-link" href="../student/student-profile.php"><i class="fa-solid fa-user me-1"></i>Profile</a>
          ...
          <a class="nav-link text-success" href="download.php"><i class="fa-solid fa-file-arrow-down me-1"></i>Download</a>
