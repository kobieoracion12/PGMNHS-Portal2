...
if(isset($_POST['register'])) {
	...
	if($insert) {
			...
			if($fk) {
				...
				while($last2 = mysqli_fetch_array($sql2)) {
					...
					if($generate) {
						...
						header("Location: ../admin/dist/faculty-accounts.php?generate-failed");
					}
				}
			}
		}
		...
		header("Location: ../admin/dist/faculty-accounts.php?insert-failed");
	}
