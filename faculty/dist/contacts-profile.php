...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Profile - Pedro Guevarra Memorial National Highschool</title>
                        ...
                        <div class="row">
                                ...
                                <div class="bg-picture card-body">
                                    <div class="d-flex align-items-top">
                                        <?php
                                            ...
                                            while($data = mysqli_fetch_array($profile)) {
                                              echo '<img src="data:image/jpg;charset=utf8;base64,'.base64_encode($data['profile_picture']).'"
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mt-0 mb-3">Registered Admin(s)</h4>
