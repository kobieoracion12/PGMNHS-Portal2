...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>My Subjects - Pedro Guevarra Memorial National Highschool</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <?php 
                                ...
                                while($subjects = mysqli_fetch_array($sql)) {
                            ?>

                            <div class="col-lg-3">
                                <div class="card">
                                    <img class="card-img-top img-fluid" src="../../assets/img/subject-ap.jpg" alt="Card image cap">
                                    <div class="card-body">
                                        <small><?php echo $subjects['subject_code'] ?></small>
                                        <h4 class="card-title"><?php echo $subjects['subject_desc'] ?></h4>
                                        <p class="card-text">
                                            <?php echo $subjects['scheduled_day'] ?> <br>
                                            <small class="text-muted"><?php echo $subjects['scheduled_time'] ?></small>
                                        </p>
                                    </div>
                                </div>
                            </div>
