                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button"
                                        ...
                                        <i class="mdi mdi-calendar-blank me-1"></i> Schedules <div class="arrow-down"></div>
                                    </a>
                                    <div class="dropdown-menu" aria-labelledby="topnav-apps">
                                        <a href="faculty-calendar.php" class="dropdown-item">Calendar</a>
                                        <a href="faculty-incoming.php" class="dropdown-item">Incoming Class</a>
                                    </div>
                                </li>
