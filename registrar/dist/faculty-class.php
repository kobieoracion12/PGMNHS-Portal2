...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>My Classes - Pedro Guevarra Memorial National Highschool</title>
                                        ...
                                        <ul class="sortable-list list-unstyled taskList" id="upcoming">
                                            ...
                                            <?php 
                                                ...
                                                while($result = mysqli_fetch_array($sql)) {
                                                    ...
                                                    $current = time() + 3600;
                                                    $time = date("h:i A", strtotime($result['scheduled_time']));
                                            ...
                                            <li>
                                                <div class="kanban-box">
                                                    <div class="kanban-detail">
                                                        <small><?php echo $result['subject_code'] ?></small>
                                                        <h5 class="mt-0"><a href="task-details.html" class="text-dark"><?php echo $result['subject_desc'] ?></a> </h5>
                                                        <ul class="list-inline">
                                                            <li class="list-inline-item">
                                                                <?php
                                                                    ...
                                                                    while($data = mysqli_fetch_array($profile)) {
                                                                    echo '<img class="img-fluid rounded-circle" src="data:image/jpg;charset=utf8;base64,'.base64_encode($data['profile_picture']).'"  width="35px">';
                                                                    }
                                                                ?>
                                                            </li>
                                                            <li class="list-inline-item">
                                                            ...
                                                            <li class="list-inline-item">
                                                                <a href="" data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="<?php echo date("h:i A", strtotime($result['scheduled_time'])) ?>">
                                            ...
                                            <small class="fst-italic">No Schedule</small>
