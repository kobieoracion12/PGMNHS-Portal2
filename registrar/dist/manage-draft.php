...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Faculty Draft - Pedro Guevarra Memorial National Highschool</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form action="manage-draft.php" method="get">
                                ...
                                <div class="card">
                                    <?php
                                        if(isset($_GET['name'])) {
                                            ...
                                            $find = mysqli_query($config, "SELECT * FROM account_info WHERE first_name = '$name' LIMIT 1");

                                            while($find_result = mysqli_fetch_array($find)) {

                                                $fname = $find_result['$first_name'];
                                    ...
                                    <div class="card-body task-detail m-2">
                                        <div class="d-flex mb-3">
                                            ...
                                            <img src="../../assets/img/profile.jpg" class="img-rounded me-2" width="50" height="auto">
                                            <div class="flex-grow-1">
                                                <h4 class="media-heading mt-1 mb-0"><?php echo $fname ?></h4>
                                                <small class="g-0">Control No</small>
                                            </div>
                                        ...
                                        <div class="task-tags mt-2">
                                            ...
                                            <span class="badge rounded-pill bg-primary p-1">Information Technology</span>
                                            ...
                                            <form class="row g-2">
                                                <div class="col-xl-6 col-md-6">
                                                    <select class="form-select">
                                                        <option class="p-2">Documents Here</option>
                                                    </select>
                                                </div>
