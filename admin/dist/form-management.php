...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Forms - Pedro Guevarra Memorial National Highschool</title>
        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                        ...
                        <li>
                            <h4 class="page-title-main">Form Management</h4>
                        </li>
        ...
        <script type="text/javascript">
          $(document).ready(function(){
            $('.edit-button').on('click', function(){
              ...
              $('#file_number').val(data[0]);
              $('#file_name').val(data[1]);
              $('#cur_dept').val(data[2]);
              $('#file_size').val(data[3]);
            })
          });
        </script>
