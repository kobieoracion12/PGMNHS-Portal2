        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                        ...
                        <li>
                            <h4 class="page-title-main">Subject Management</h4>
                        </li>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row px-2">
                                            <div class="col-12">
                                                <button type="button" data-bs-toggle="modal" data-bs-target="#addsubject" class="btn btn-success waves-effect waves-light add-subject"><i class="mdi mdi-plus me-1"></i>Add Subject</button>
                                            </div>
                                                ...
                                                <div class="modal-dialog modal-md modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title" id="myLargeModalLabel">Add Subject</h4>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body text-start px-4">

                                                            <form action="../../php/add-subject.php" method="post">
                                                                <label class="form-label" for="subject_name">Subject Name:</label>
                                                                <input type="text" class="form-control mb-2" name="subject_name" id="subject_name">

                                                                <input type="submit" class="btn btn-success w-100 my-2" name="submit-subject">
                                                            </form>
                                        ...
                                        <div class="row px-2">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-hover w-100 mt-2">
                                                    ...
                                                    <tr>
                                                        <td class="text-center p-3"><?php echo $subject['subject_code']; ?></td>
                                                        <td class="text-center p-3"><?php echo $subject['subject_desc']; ?></td>
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-hidden="true">
                                                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h4 class="modal-title" id="myLargeModalLabel">Edit Subject</h4>
                                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                            </div>
                                                                            <div class="modal-body text-start px-4">

                                                                                <form action="../../php/update-subject.php" method="post">
                                                                                    <label class="form-label" for="file_name">Subject Code:</label>
                                                                                    <input type="text" class="form-control text-muted mb-2" name="subject_code" id="subject_code" readonly>

                                                                                    <label class="form-label" for="file_dept">Subject Name:</label>
                                                                                    <input type="text" class="form-control mb-2" name="subject_desc" id="subject_desc">

                                                                                    <input type="submit" class="btn btn-success w-100 my-2" name="update-subject">
                                                                                </form>
